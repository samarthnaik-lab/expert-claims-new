    ...
    const fetchClaimDetails = async () => {
      try {
        ...
        const response = await fetch(
          'https://n8n.srv952553.hstgr.cloud/webhook/customer-case',
          {
            ...
            headers: {
              ...
              'jwt_token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6IiIsInBhc3N3b3JkIjoiIiwiaWF0IjoxNzU2NzkzMjA3fQ.R8N3U28XD4zQ_ixGNgtBtUKK5F8gGaQg8lrPPWr88dY',
            },
            body: formData,
          }
        );
        ...
        if (response.ok) {
          ...
          fetchDocuments(String(searchCaseId));
        } else {
